...
## パンフレットの目的
・白馬の水やmymizuのアプリ、給水所の存在を白馬に来てくれる人（＝myzmizuを利用する可能性が高い人）に認知しても貰う為。

消費者の行動心理のプロセスをしめす理論の中にAISASモデルというものがある。
...
現段階で白馬の水は「Attention：認知・注意」の段階にとどまっていると考えられる。　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　そのため、まずは認知を広げる必要があると考えた。
...
上記よりパンフレットは白馬の水への理解を観光客へ促すのに効果的であるとかんがえられる。　
...
### →電子パンフレットに関して
環境の面から見ると、電子媒体の方が環境に良いという意見も出ているが、紙媒体ならではのメリットもある。
...
この調査を見ると、特に説明文に関して電子媒体より紙媒体の方が理解と記憶により良く作用すると考えられる。　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　パンフレットは説明文主体の媒体なので電子媒体よりも紙媒体を利用した方が効果的であると考えられる。
### →ウェブサイトでも良いのではないか？  
・今回のパンフレットは内容の範囲が狭いということもあり、ホームページを観光客が自ら検索し閲覧してくれる可能性は少ない。 

・ホームページを作成、維持、管理するのに多少の専門知識がいる。
...
# 〇まとめ  
### 最終目標  
観光客が白馬の水に気軽にアクセスできるようにし、マイボトル文化を醸成する  
### ・なぜパンフレットなのか？  
  
・観光客にアピールするという目的で、高校生が簡単に行える方法であると考えたから  
  
・白馬村の水やmymizuアプリなどの観光客への認知が足りないと感じたので、ほかの観光パンフレットとは違う「水についての情報のみを伝えるパンフレット」を作成する  
・そしてウェブサイトよりも目に入る機会が多く、かつ形として残る紙のパンフレットを採用  
  

### ・パンフレットの内容に関して  
  
・白馬村の水がおいしい理由やその水にアクセスするために必要な情報、給水所で使用するであろうマイボトルについての情報を掲載  
